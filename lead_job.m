function lead_job
% - Lead-DBS Job created on 16-Dec-2022 13:33:10 -
% --------------------------------------
...
options.earoot = '/Users/linasundqvist/lead/';
...
options.d2.backdrop = 'Patient Pre-OP (T1)';
...
options.uipatdirs = {'/Users/linasundqvist/Desktop/DBS_thesis/patients/PilotDBS_1'};
...
options.prefs.lc.datadir = '/Users/linasundqvist/lead/connectomes/';
...
options.prefs.genetics.dbdir = '/Users/linasundqvist/lead/templates/pat.space/MNI_ICBM_2009b_NLIN_ASYM/genetics/';
...
options.prefs.machine.d2.backdrop = 'Patient Pre-OP (T1)';
options.prefs.machine.d2.fid_overlay = 1;
options.prefs.machine.lc.general.parcellation = 'Voxelwise Parcellation t05 8k (Lead-DBS)';
...
options.prefs.machine.normsettings.ants_numcores = '4';
...
options.lc.general.parcellation = 'Voxelwise Parcellation t05 8k (Lead-DBS)';
