...
%try
    ...
    %% Optimization
        ...
        %% Optimisation 1, maximum target coverage, constrained constraint area coverage
        % parallelisation makes it slower
        ...
        %% Optimization 2, minimal activation of constraint areas, minimum X percent of target points activated
        for m=(1:length(alpha))
          b = -EFobj_target;
        ...
        fid=fopen(append(pat_path,hand{i},'_suggestion_',space,'.txt'),'w');
