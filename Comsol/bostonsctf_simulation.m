function out = model
%
% bostonsctf_simulation.m
%
% Model exported on Jun 12 2024, 19:13 by COMSOL 5.6.0.401.
...
model.label('bostonsctf_simulation.mph');
...
model.component('comp1').geom('geom1').run('sel28');
model.component('comp1').geom('geom1').create('sel29', 'ExplicitSelection');
model.component('comp1').geom('geom1').feature('sel29').selection('selection').set('fin', [4 9]);
model.component('comp1').geom('geom1').feature('sel29').label('All Contacts except C1 C2A');
model.component('comp1').geom('geom1').feature.duplicate('sel30', 'sel29');
model.component('comp1').geom('geom1').feature('sel30').label('All Contacts except C1 C2B');
model.component('comp1').geom('geom1').runPre('sel30');
model.component('comp1').geom('geom1').feature('sel30').selection('selection').clear('fin');
model.component('comp1').geom('geom1').feature('sel30').selection('selection').set('fin', [4 16]);
model.component('comp1').geom('geom1').feature('sel30').label('All Contacts except C1 2B');
model.component('comp1').geom('geom1').feature('sel29').label('All Contacts except C1 2A');
model.component('comp1').geom('geom1').feature.duplicate('sel31', 'sel30');
model.component('comp1').geom('geom1').feature.move('sel31', 37);
model.component('comp1').geom('geom1').feature('sel31').label('All Contacts except C1 2C');
model.component('comp1').geom('geom1').runPre('sel31');
model.component('comp1').geom('geom1').feature('sel31').selection('selection').clear('fin');
model.component('comp1').geom('geom1').feature('sel31').selection('selection').set('fin', [4 6]);
model.component('comp1').geom('geom1').feature.duplicate('sel32', 'sel29');
model.component('comp1').geom('geom1').feature.move('sel32', 38);
model.component('comp1').geom('geom1').feature('sel32').label('All Contacts except C4 3A');
model.component('comp1').geom('geom1').runPre('sel32');
model.component('comp1').geom('geom1').feature('sel32').selection('selection').clear('fin');
model.component('comp1').geom('geom1').feature('sel32').selection('selection').set('fin', [14 15]);
model.component('comp1').geom('geom1').feature.duplicate('sel33', 'sel32');
model.component('comp1').geom('geom1').feature.move('sel33', 39);
model.component('comp1').geom('geom1').feature('sel33').label('All Contacts except C4 3B');
model.component('comp1').geom('geom1').runPre('sel33');
model.component('comp1').geom('geom1').feature('sel33').selection('selection').clear('fin');
model.component('comp1').geom('geom1').feature('sel33').selection('selection').set('fin', [15 20]);
model.component('comp1').geom('geom1').feature.duplicate('sel34', 'sel33');
model.component('comp1').geom('geom1').feature.move('sel34', 40);
model.component('comp1').geom('geom1').runPre('sel34');
model.component('comp1').geom('geom1').feature('sel34').selection('selection').clear('fin');
model.component('comp1').geom('geom1').feature('sel34').selection('selection').set('fin', [10 15]);
model.component('comp1').geom('geom1').feature('sel34').label('All Contacts except C4 3C');

model.label('bostonsctf_simulation.mph');

model.component('comp1').geom('geom1').feature('sel29').selection('selection').set('fin', 4);
model.component('comp1').geom('geom1').feature('sel29').selection('selection').clear('fin');
model.component('comp1').geom('geom1').feature('sel29').selection('selection').set('fin', [6 10 14 15 16 20]);
model.component('comp1').geom('geom1').runPre('sel30');
model.component('comp1').geom('geom1').feature('sel30').selection('selection').set('fin', [6 9 10 14 15 20]);
model.component('comp1').geom('geom1').runPre('sel31');
model.component('comp1').geom('geom1').feature('sel31').selection('selection').set('fin', [9 10 14 15 16 20]);
model.component('comp1').geom('geom1').runPre('sel32');
model.component('comp1').geom('geom1').feature('sel32').selection('selection').set('fin', [4 6 9 10 16 20]);
model.component('comp1').geom('geom1').runPre('sel33');
model.component('comp1').geom('geom1').feature('sel33').selection('selection').set('fin', [4 6 9 10 14 16]);
model.component('comp1').geom('geom1').runPre('sel34');
model.component('comp1').geom('geom1').feature('sel34').selection('selection').set('fin', [4 6 9 14 16 20]);

model.label('bostonsctf_simulation.mph');

model.component('comp1').geom('geom1').feature.duplicate('sel35', 'sel34');
model.component('comp1').geom('geom1').feature.move('sel35', 41);
...
model.component('comp1').geom('geom1').feature('sel35').selection('selection').set('fin', [4 6 10 14 15 16]);
...
model.component('comp1').geom('geom1').feature('sel36').selection('selection').set('fin', [4 6 14 15 16 20]);
...
model.component('comp1').geom('geom1').feature('sel37').selection('selection').set('fin', [4 6 9 10 15 20]);
...
model.component('comp1').geom('geom1').feature('sel38').selection('selection').set('fin', [4 6 9 14 15 20]);
...
model.component('comp1').geom('geom1').feature('sel39').selection('selection').set('fin', [4 9 10 15 16 20]);
...
model.component('comp1').geom('geom1').feature('sel40').selection('selection').set('fin', [4 9 10 14 15 16]);
...
model.component('comp1').geom('geom1').feature('sel29').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel29').selection('selection').set('fin', [15 26 38 41 55 64]);
model.component('comp1').geom('geom1').runPre('sel30');
model.component('comp1').geom('geom1').feature('sel30').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel30').selection('selection').set('fin', [15 23 26 38 41 64]);
model.component('comp1').geom('geom1').run('sel30');
model.component('comp1').geom('geom1').feature('sel31').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel31').selection('selection').set('fin', [23 26 38 41 55 64]);
model.component('comp1').geom('geom1').run('sel31');
model.component('comp1').geom('geom1').feature('sel32').selection('selection').set('fin', [6 9 10 16 20]);
model.component('comp1').geom('geom1').feature('sel32').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel32').selection('selection').set('fin', [12 15 23 26 55 64]);
model.component('comp1').geom('geom1').run('sel32');
model.component('comp1').geom('geom1').feature('sel33').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel33').selection('selection').set('fin', [12 15 23 26 38 55]);
model.component('comp1').geom('geom1').run('sel33');
model.component('comp1').geom('geom1').feature('sel34').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel34').selection('selection').set('fin', [12 15 23 38 55 64]);
model.component('comp1').geom('geom1').run('sel34');
model.component('comp1').geom('geom1').feature('sel35').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel35').selection('selection').set('fin', [12 15 26 38 41 55]);
model.component('comp1').geom('geom1').run('sel35');
model.component('comp1').geom('geom1').feature('sel36').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel36').selection('selection').set('fin', [12 15 38 41 55 64]);
model.component('comp1').geom('geom1').run('sel36');
model.component('comp1').geom('geom1').feature('sel37').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel37').selection('selection').set('fin', [12 15 23 26 41 64]);
model.component('comp1').geom('geom1').run('sel37');
model.component('comp1').geom('geom1').feature('sel38').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel38').selection('selection').set('fin', [12 15 23 38 41 64]);
model.component('comp1').geom('geom1').run('sel38');
model.component('comp1').geom('geom1').feature('sel39').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel39').selection('selection').set('fin', [12 23 26 41 55 64]);
model.component('comp1').geom('geom1').run('sel39');
model.component('comp1').geom('geom1').feature('sel40').selection('selection').init(2);
model.component('comp1').geom('geom1').feature('sel40').selection('selection').set('fin', [12 23 26 38 41 55]);
model.component('comp1').geom('geom1').run('sel40');
...
model.component('comp1').geom('geom1').run('sel41');
