...
model.component('comp1').geom('geom1').feature('imp1').set('filename', [cd, filesep,'Comsol',filesep,'Leads',filesep,'BostonScientific2202_lead.mphbin']);
...
model.component('comp1').geom('geom1').feature('sel11').selection('selection').set('fin', [2 3 22]); % [2 3 22]
...
mphsave('Comsol/bostonsctf_simulationTerminal.mph')
