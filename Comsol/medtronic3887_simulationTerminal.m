...
model.component('comp1').geom('geom1').feature('imp1').set('filename', [cd, filesep,'Comsol',filesep,'Leads',filesep,'Medtronic3387_lead.mphbin']);
...
mphsave('Comsol/medtronic3887_simulationTerminal.mph')
