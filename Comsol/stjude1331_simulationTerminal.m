...
model.component('comp1').geom('geom1').feature('sel2').selection('selection').set('fin', 41);
...
model.component('comp1').geom('geom1').feature('sel3').selection('selection').set('fin', 75);
...
model.component('comp1').geom('geom1').feature('sel4').selection('selection').set('fin', 23);
...
model.component('comp1').geom('geom1').feature('sel5').selection('selection').set('fin', 58);
...
model.component('comp1').geom('geom1').feature('sel6').selection('selection').set('fin', 86);
...
model.component('comp1').geom('geom1').feature('sel8').selection('selection').set('fin', 55);
